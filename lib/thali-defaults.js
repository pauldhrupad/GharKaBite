const baseChoice = {
  ...
  options: [
    { id: "rice", name: "Rice", priceAdjustment: 0, active: true, stock: null },
    { id: "roti", name: "Roti", priceAdjustment: 0, active: true, stock: null },
  ],
};
const add = (id, name, price, maxQuantity = 3) => ({ id, name, description: "", price, active: true, maxQuantity, stock: null });
