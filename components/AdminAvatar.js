...
export default function AdminAvatar() {
  ...
  return <div className="relative shrink-0">
    <button ref={triggerRef} type="button" onClick={() => setOpen((current) => !current)} aria-label="Owner profile" aria-expanded={open} aria-controls="admin-profile-photo-panel" className="grid size-11 place-items-center overflow-hidden rounded-full bg-primary text-xs font-black text-white ring-offset-2 hover:ring-2 hover:ring-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
